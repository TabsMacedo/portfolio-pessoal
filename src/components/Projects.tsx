...
import { Github, ExternalLink, CodeXml, LayoutDashboard, DollarSign, BookOpen, Brain, ChevronLeft, ChevronRight, Activity } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="relative">
                ...
                {project.imageUrl && (
                  <div className="mb-4 rounded-lg overflow-hidden">
                    <img
                      ...
                      onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x300/cccccc/000000?text=Imagem+Indisponível'; }}
                    />
                  </div>
                )}
        ...
        <div className="swiper-pagination-custom !relative !bottom-0 mt-8 flex justify-center gap-2"></div>
      </div>
    </motion.section>
  );
}
